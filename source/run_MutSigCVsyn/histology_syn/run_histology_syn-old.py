...
if hyper in ['no','n']:
    dir_cov = '../data/cov/histology_old/'
    dir_maf = '../data/maf/histology_old/'
elif hyper in ['yes','y']:
    dir_cov = '../data/cov/histology_old_nohypermutator/'
    dir_maf = '../data/maf/histology_old_nohypermutator/'
...
def runMutSigCV_syn(feat):
    ...
    outp = os.path.join('../mutsig_out/syn/', out_dir ,feat, feat)
